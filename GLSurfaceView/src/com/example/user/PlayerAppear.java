...
public class PlayerAppear extends Sprite {
	...
	public static Player CreatePlayer( int liney , String playername )
	{
		...
		{
			player.Init( Const.LINE_LEFT_1_X  , Const.LINE_1_Y , Const.LINE_1_W , Const.LINE_1_W , 3 , 1 , 5 , id , Const.SpriteType.TYPE_PLAYER.getValue() );			
			player.setLineNum(Const.LINE1);
		}
		else if( liney == Const.LINE_2_Y)
		{
			player.Init( Const.LINE_LEFT_2_X  , Const.LINE_2_Y , Const.LINE_2_W , Const.LINE_2_W , 3 , 1 , 5 , id , Const.SpriteType.TYPE_PLAYER.getValue() );			
			player.setLineNum(Const.LINE2);
		}
		else if( liney == Const.LINE_3_Y)
		{
			player.Init( Const.LINE_LEFT_3_X  , Const.LINE_3_Y , Const.LINE_3_W , Const.LINE_3_W , 3 , 1 , 5 , id , Const.SpriteType.TYPE_PLAYER.getValue() );			
